...
const globalSocket = new GlobalSocket(io, httpServer, 5000);
...
//   socket.on('raiseHand', (askingtalk:any) => {
//     askingTalkArray.push(askingtalk);
//     console.log("ASKINGTALK ::::: ", askingtalk);
//     clients.forEach(client => {
//       client.emit('raiseHandAdded', askingTalkArray); 
//     });
//   });
...
//   socket.on('lowerHand', (askingtalkid: Number) => {
//     askingTalkArray = askingTalkArray.filter((askingtalk: any) => {
//       return askingtalk.id !== askingtalkid;
//     });
//     clients.forEach(client => {
//       client.emit('lowerHandRegistered', askingTalkArray);  
//     });
